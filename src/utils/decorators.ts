//https://github.com/omirobarcelo/catch-decorator

import { UnexpectedError } from '../libs/errorlib';
...
export const BubbleUnexpectedError = (): any => Catch(Error, UnexpectedError);
